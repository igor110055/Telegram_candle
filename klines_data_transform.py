...
class KlinesDataTransform():
    ...
    @staticmethod
    def klines_list_to_dataframes(symbol:str, klines_data: list, interval:str,
        ...
        klines_DataFrame["interval"] = interval
    ...
    @staticmethod
    def klines_json_string_to_dataframes(symbol:str, klines_json_string: str, interval:str,
                        column_names_order:list = DEFAULT_COLUMN_NAMES_ORDER) -> pandas.DataFrame:
        ...
        return KlinesDataTransform.klines_list_to_dataframes(symbol, klines_python_list, interval, column_names_order)

    @staticmethod
    def klines_json_file_to_dataframes(symbol:str, klines_json_file: str, interval:str,
                        column_names_order:list = DEFAULT_COLUMN_NAMES_ORDER) -> pandas.DataFrame:
